...
function fastwc_admin_plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
	...
	if ( function_exists( 'fastwc_get_app_id' ) ) {
		if ( empty( Config::get_app_id() ) ) {
			$plugin_meta[] = sprintf(
				'<a href="%1$s" target="_blank" rel="noopener"><strong>%2$s</strong></a>',
				esc_url( Config::get_onboarding_url() ),
...
function fastwc_admin_setup_sections() {
	...
	register_setting( $section_name, Config::KEY_APP_ID );

	$section_name = 'fast_styles';
	add_settings_section( $section_name, '', false, $section_name );
	register_setting( $section_name, Config::KEY_LOAD_BUTTON_STYLES );
	register_setting( $section_name, Config::KEY_USE_DARK_MODE );
	register_setting( $section_name, Config::KEY_PDP_BUTTON_STYLES );
	register_setting( $section_name, Config::KEY_CART_BUTTON_STYLES );
	register_setting( $section_name, Config::KEY_MINI_CART_BUTTON_STYLES );
	register_setting( $section_name, Config::KEY_CHECKOUT_BUTTON_STYLES );
	register_setting( $section_name, Config::KEY_LOGIN_BUTTON_STYLES );

	$section_name = 'fast_options';
	add_settings_section( $section_name, '', false, $section_name );
	register_setting( $section_name, Config::KEY_PDP_BUTTON_HOOK );
	register_setting( $section_name, Config::KEY_PDP_BUTTON_HOOK_OTHER );
	register_setting( $section_name, Config::KEY_BUTTON_WRAPPER_CONTENT );
	register_setting( $section_name, Config::KEY_BUTTON_WRAPPER_CONTENT_LOCATION );
	register_setting( $section_name, Config::KEY_HIDE_BUTTON_PRODUCTS );
	register_setting( $section_name, Config::KEY_CHECKOUT_REDIRECT_PAGE );
	register_setting( $section_name, Config::KEY_REDIRECT_AFTER_PDP );
	register_setting( $section_name, Config::KEY_CLEAR_CART_AFTER_PDP );
	register_setting( $section_name, Config::KEY_HIDE_REGULAR_CHECKOUT_BUTTONS );
	register_setting( $section_name, Config::KEY_SHOW_LOGIN_BUTTON_FOOTER );

	$section_name = 'fast_test_mode';
	add_settings_section( $section_name, '', false, $section_name );
	register_setting( $section_name, Config::KEY_TEST_MODE );
	register_setting( $section_name, Config::KEY_TEST_MODE_USERS );
	register_setting( $section_name, Config::KEY_DEBUG_MODE );
	register_setting( $section_name, Config::KEY_DISABLE_MULTICURRENCY );

	// For now, only allow fast users to see advanced settings.
	if ( fastwc_should_show_advanced_settings() ) {
		$section_name = 'fast_advanced';
		add_settings_section( $section_name, '', false, $section_name );
		register_setting( $section_name, Config::KEY_FAST_JS_URL );
		register_setting( $section_name, Config::KEY_FAST_JWKS_URL );
		register_setting( $section_name, Config::KEY_ONBOARDING_URL );
		register_setting( $section_name, Config::KEY_DASHBOARD_URL );
	}
}
...
function fastwc_admin_setup_fields() {
	...
	add_settings_field( Config::KEY_APP_ID, __( 'App ID', 'fast' ), 'fastwc_app_id_content', $settings_section, $settings_section );

	// Button style settings.
	$settings_section = 'fast_styles';
	add_settings_field( Config::KEY_LOAD_BUTTON_STYLES, __( 'Load Button Styles', 'fast' ), 'fastwc_load_button_styles', $settings_section, $settings_section );
	add_settings_field( Config::KEY_USE_DARK_MODE, __( 'Enable Dark Mode', 'fast' ), 'fastwc_setting_use_dark_mode', $settings_section, $settings_section );
	add_settings_field( Config::KEY_PDP_BUTTON_STYLES, __( 'Product page button styles', 'fast' ), 'fastwc_pdp_button_styles_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_CART_BUTTON_STYLES, __( 'Cart page button styles', 'fast' ), 'fastwc_cart_button_styles_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_MINI_CART_BUTTON_STYLES, __( 'Mini cart widget button styles', 'fast' ), 'fastwc_mini_cart_button_styles_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_CHECKOUT_BUTTON_STYLES, __( 'Checkout page button styles', 'fast' ), 'fastwc_checkout_button_styles_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_LOGIN_BUTTON_STYLES, __( 'Login button styles', 'fast' ), 'fastwc_login_button_styles_content', $settings_section, $settings_section );

	// Button options settings.
	$settings_section = 'fast_options';
	add_settings_field( Config::KEY_PDP_BUTTON_HOOK, __( 'Select Product Button Location', 'fast' ), 'fastwc_pdp_button_hook', $settings_section, $settings_section );
	add_settings_field( Config::KEY_PDP_BUTTON_HOOK_OTHER, __( 'Enter Alternate Product Button Location', 'fast' ), 'fastwc_pdp_button_hook_other', $settings_section, $settings_section );
	add_settings_field( Config::KEY_BUTTON_WRAPPER_CONTENT, __( 'Extra Button Content', 'fast' ), 'fastwc_button_wrapper_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_BUTTON_WRAPPER_CONTENT_LOCATION, __( 'Location of Extra Button Content', 'fast' ), 'fastwc_button_wrapper_content_location', $settings_section, $settings_section );
	add_settings_field( Config::KEY_HIDE_BUTTON_PRODUCTS, __( 'Hide Buttons for these Products', 'fast' ), 'fastwc_hide_button_products', $settings_section, $settings_section );
	add_settings_field( Config::KEY_CHECKOUT_REDIRECT_PAGE, __( 'Checkout Redirect Page', 'fast' ), 'fastwc_checkout_redirect_page', $settings_section, $settings_section );
	add_settings_field( Config::KEY_REDIRECT_AFTER_PDP, __( 'Redirect to a custom page after a PDP order', 'fast' ), 'fastwc_redirect_after_pdp_order', $settings_section, $settings_section );
	add_settings_field( Config::KEY_CLEAR_CART_AFTER_PDP, __( 'Clear the cart after a PDP order', 'fast' ), 'fastwc_clear_cart_after_pdp_order', $settings_section, $settings_section );
	add_settings_field( Config::KEY_HIDE_REGULAR_CHECKOUT_BUTTONS, __( 'Hide WooCommerce Checkout Buttons on Cart', 'fast' ), 'fastwc_hide_regular_checkout_buttons', $settings_section, $settings_section );
	add_settings_field( Config::KEY_SHOW_LOGIN_BUTTON_FOOTER, __( 'Display Login in Footer', 'fast' ), 'fastwc_show_login_button_footer', $settings_section, $settings_section );

	// Test Mode settings.
	$settings_section = 'fast_test_mode';
	add_settings_field( Config::KEY_TEST_MODE, __( 'Test Mode', 'fast' ), 'fastwc_test_mode_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_TEST_MODE_USERS, __( 'Test Mode Users', 'fast' ), 'fastwc_test_mode_users', $settings_section, $settings_section );
	add_settings_field( Config::KEY_DEBUG_MODE, __( 'Debug Mode', 'fast' ), 'fastwc_debug_mode_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_DISABLE_MULTICURRENCY, __( 'Disable Multicurrency Support', 'fast' ), 'fastwc_disable_multicurrency_content', $settings_section, $settings_section );

	// Advanced settings.
	$settings_section = 'fast_advanced';
	add_settings_field( Config::KEY_FAST_JS_URL, __( 'Fast JS URL', 'fast' ), 'fastwc_fastwc_js_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_FAST_JWKS_URL, __( 'Fast JWKS URL', 'fast' ), 'fastwc_fastwc_jwks_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_ONBOARDING_URL, __( 'Fast Onboarding URL', 'fast' ), 'fastwc_onboarding_url_content', $settings_section, $settings_section );
	add_settings_field( Config::KEY_DASHBOARD_URL, __( 'Fast Seller Dashboard URL', 'fast' ), 'fastwc_dashboard_url_content', $settings_section, $settings_section );
}
...
function fastwc_load_button_styles() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_LOAD_BUTTON_STYLES,
			'current'     => Config::should_load_button_styles() ? '1' : 0,
...
function fastwc_setting_use_dark_mode() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_USE_DARK_MODE,
			'current'     => Config::should_use_dark_mode() ? '1' : 0,
...
function fastwc_pdp_button_styles_content() {
	fastwc_settings_field_textarea(
		array(
			'name'  => Config::KEY_PDP_BUTTON_STYLES,
			'value' => Config::get_pdp_button_styles(),
		)
	);
}
...
function fastwc_cart_button_styles_content() {
	fastwc_settings_field_textarea(
		array(
			'name'  => Config::KEY_CART_BUTTON_STYLES,
			'value' => Config::get_cart_button_styles(),
		)
	);
}
...
function fastwc_mini_cart_button_styles_content() {
	fastwc_settings_field_textarea(
		array(
			'name'  => Config::KEY_MINI_CART_BUTTON_STYLES,
			'value' => Config::get_mini_cart_button_styles(),
		)
	);
}
...
function fastwc_checkout_button_styles_content() {
	fastwc_settings_field_textarea(
		array(
			'name'  => Config::KEY_CHECKOUT_BUTTON_STYLES,
			'value' => Config::get_checkout_button_styles(),
		)
	);
}
...
function fastwc_login_button_styles_content() {
	fastwc_settings_field_textarea(
		array(
			'name'  => Config::KEY_LOGIN_BUTTON_STYLES,
			'value' => Config::get_login_button_styles(),
		)
	);
}
...
function fastwc_pdp_button_hook_other() {
	fastwc_settings_field_input(
		array(
			'name'        => Config::KEY_PDP_BUTTON_HOOK_OTHER,
			...
			'value'       => Config::get_other_pdp_button_hook(),
		)
	);
}
...
function fastwc_button_wrapper_content_location() {
	...
	fastwc_settings_field_select(
		array(
			'name'        => Config::KEY_BUTTON_WRAPPER_CONTENT_LOCATION,
			...
			'value'       => Config::get_button_wrapper_content_location(),
		)
	);
}
...
function fastwc_hide_button_products() {
	$fastwc_setting_hide_button_products = Config::get_products_to_hide_buttons();
	...
	fastwc_settings_field_ajax_select(
		array(
			'name'        => Config::KEY_HIDE_BUTTON_PRODUCTS,
			'selected'    => $selected,
...
function fastwc_checkout_redirect_page() {
	$fastwc_setting_checkout_redirect_page = Config::get_checkout_redirect_page();
	...
	fastwc_settings_field_ajax_select(
		array(
			'name'        => Config::KEY_CHECKOUT_REDIRECT_PAGE,
			'selected'    => $selected,
...
function fastwc_redirect_after_pdp_order() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_REDIRECT_AFTER_PDP,
			'current'     => Config::should_redirect_after_pdp_checkout() ? '1' : '0',
...
function fastwc_clear_cart_after_pdp_order() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_CLEAR_CART_AFTER_PDP,
			'current'     => Config::should_clear_cart_after_pdp_checkout() ? '1' : '0',
...
function fastwc_hide_regular_checkout_buttons() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_HIDE_REGULAR_CHECKOUT_BUTTONS,
			'current'     => Config::should_hide_regular_checkout_buttons() ? '1' : '0',
...
function fastwc_show_login_button_footer() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_SHOW_LOGIN_BUTTON_FOOTER,
			'current'     => Config::should_show_login_in_footer() ? '1' : 0,
...
function fastwc_test_mode_content() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_TEST_MODE,
			'current'     => Config::is_test_mode() ? '1' : 0,
...
function fastwc_test_mode_users() {
	...
	fastwc_settings_field_ajax_select(
		array(
			'name'        => Config::KEY_TEST_MODE_USERS,
			'selected'    => $selected,
...
function fastwc_debug_mode_content() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_DEBUG_MODE,
			'current'     => Config::is_debug_mode() ? '1' : 0,
...
function fastwc_disable_multicurrency_content() {
	fastwc_settings_field_checkbox(
		array(
			'name'        => Config::KEY_DISABLE_MULTICURRENCY,
			'current'     => Config::should_disable_multicurrency() ? '1' : 0,
...
function fastwc_fastwc_js_content() {
	fastwc_settings_field_input(
		array(
			'name'  => Config::KEY_FAST_JS_URL,
			'value' => Config::get_fast_js_url(),
		)
	);
}
...
function fastwc_fastwc_jwks_content() {
	fastwc_settings_field_input(
		array(
			'name'  => Config::KEY_FAST_JWKS_URL,
			'value' => Config::get_fast_jwks_url(),
		)
	);
}
...
function fastwc_onboarding_url_content() {
	fastwc_settings_field_input(
		array(
			'name'  => Config::KEY_ONBOARDING_URL,
			'value' => Config::get_onboarding_url(),
		)
	);
}
...
function fastwc_dashboard_url_content() {
	fastwc_settings_field_input(
		array(
			'name'  => Config::KEY_DASHBOARD_URL,
			'value' => Config::get_dashboard_url(),
		)
	);
}
...
function fastwc_get_option_or_set_default( $option, $default ) {
	return Config::get_option_or_set_default( $option, $default );
}
